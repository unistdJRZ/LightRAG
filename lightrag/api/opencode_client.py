...
def _build_message(
    ...
    lines = [
        ...
        "",
        "Use the LightRAG agent APIs to search the database for the retrieval target below.",
        "When you finish, call /api/agent/submit with the exact workspace and agent_submit_id above.",
        "Treat any prior_rag_context as retrieval hints, not as the final answer.",
        "Use the agent APIs to verify, expand, and refine the evidence before submitting.",
    ]
